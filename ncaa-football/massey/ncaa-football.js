...
class MasseyFBall {
	constructor(){
		this.urls = {
			'inter' : 'https://www.masseyratings.com/scores.php?s=318889&sub=11604&all=1&mode=2&format=1',
			'intra' : 'https://www.masseyratings.com/scores.php?s=318889&sub=11604&all=1&mode=1&format=1',
			'names' : 'https://www.masseyratings.com/scores.php?s=318889&sub=11604&all=1&mode=3&format=2'
		};
		...
		return new Promise((resolve, reject) => {
			...
			Promise.all([this.loadNames(),this.loadIntra(),this.loadInter()])
				.then((result)=>{
					...
					fs.writeFileSync('./data/all-games-2020.json',JSON.stringify(this.games, null, 4));
