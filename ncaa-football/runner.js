...
var getHomeFieldAdvantageAverage = function(masseyGames){
	...
	console.log('home field advantage calculated as ' + HomeFieldAdv + ' points per game');
...
myMasseyFBall.loadEverything()
	.then(()=>{
		...
		let masseyGames = myMasseyFBall.getAllGames();
		...
		let formattedTeams = formatTeams(myMasseyFBall.getAllTeams());
...
// myMasseyFBall.loadIntra(function(result){
// 	console.log(result);
// });